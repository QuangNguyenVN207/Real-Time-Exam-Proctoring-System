...
class WebcamInteractionController:
    ...
    def __post_init__(self) -> None:
        ...
        self.classifier_reset_requested = False
    ...
    def handle_key(self, raw_key: int) -> None:
        ...
        if key in (ord("q"), ord("Q")):
            ...
            self.classifier_reset_requested = True
            self.status_message = "Classifier reset requested"
            print(f"\n{self.status_message}")
    ...
    def consume_classifier_reset(self) -> bool:
        requested = self.classifier_reset_requested
        self.classifier_reset_requested = False
        return requested

    def overlay_lines(self) -> tuple[str, str]:
        controls = (
            "A assign | U unassign | R retry | X reset classifier | F save+quit | "
            "+/- FPS | Q quit"
        )
