...
Examples:
    python -m backend.ai_services.pose_gaze.test_holistic_media input.jpg
    python -m backend.ai_services.pose_gaze.test_holistic_media input.mp4 --target-fps 8
    python -m backend.ai_services.pose_gaze.test_holistic_media input.mp4 --no-display
"""
...
# Reduce MediaPipe/TensorFlow native diagnostic output. Python exceptions are
